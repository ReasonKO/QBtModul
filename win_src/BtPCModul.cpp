...
#include <C:\Program Files (x86)\Microsoft SDKs\Windows\v7.1A\Include\BluetoothAPIs.h>
#include "SearchCom.h"
...
{
    nxtclass->setport(SearchCom(nxtclass->BTaddr));
...
{
    if (::ComTest(nxtclass->portIsReady()))
    {
        nxtclass->setport(0);
        return false;
    }
