...
void Widget::refresh()
{
    ...
    ui->lineEdit_2->setText(QString().setNum(nxtclass[RobActNom]->getport()));
    ui->checkBox->setChecked(nxtclass[RobActNom]->authenticated);
    ui->C_Connect->setChecked(nxtclass[RobActNom]->connected);
    ui->B_Send->setEnabled(nxtclass[RobActNom]->authenticated && (nxtclass[RobActNom]->getport()>0));
    ui->B_Connect->setEnabled(nxtclass[RobActNom]->authenticated && (nxtclass[RobActNom]->getport()>0));
    ui->B_Disconnect->setEnabled(nxtclass[RobActNom]->authenticated && (nxtclass[RobActNom]->getport()>0));
...
void Widget::on_B_reset_clicked()
{
